...
inline auto
Varredura::espiral(Geratriz geratriz, float deslX, float nRev, int nSubdiv, float deltinhaAltura, float deltinhaLargura, bool tampa)
{
	constexpr auto pi = math::pi<float>();
...
inline auto
Varredura::translacaoTorcao(Geratriz geratriz, float comprimento, float deslHorizontal, float deslVertical, int nSubdiv, float escalaInicial, float escalaFinal, float torcao, bool tampa) {
